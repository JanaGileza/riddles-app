...
attemptsUsed() => displays to the user that they initally get 3 attempts, increments attempts used for each false answer, resets back to 0 used guesses upon a new riddle being displayed
